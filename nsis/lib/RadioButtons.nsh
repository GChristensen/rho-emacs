  ...
  !macro SectionRadioButtons _d _e
    ...
    !insertmacro StartRadioButtons_ ${_d}
    ...
    ${Do}
      ...
      ${If} $4 <= $3
      ${AndIf} $6 != ""
        !insertmacro RadioButton_ $6
      ${AndIf} $4 == $3
        !insertmacro RadioButton_ $7
      ${EndIf}
 
    ${LoopUntil} $4 >= $3
 
    !insertmacro EndRadioButtons_
